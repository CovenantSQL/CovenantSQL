...
go build -ldflags "-X main.version=${version} -X gitlab.com/thunderdb/ThunderDB/conf.Role=B"  -o bin/thunderdbd ${thunderdbd_pkgpath}

miner_pkgpath="gitlab.com/thunderdb/ThunderDB/cmd/miner"
go build -ldflags "-X main.version=${version} -X gitlab.com/thunderdb/ThunderDB/conf.Role=M"  -o bin/thunderminerd ${miner_pkgpath}
