...
func TestConfiguration_hasVote(t *testing.T) {
	if isPeer(sampleConfiguration, "id0") {
		t.Fatalf("id0 should not have vote")
	}
	if !isPeer(sampleConfiguration, "id1") {
		t.Fatalf("id1 should have vote")
	}
	if isPeer(sampleConfiguration, "id2") {
		t.Fatalf("id2 should not have vote")
	}
	if isPeer(sampleConfiguration, "someotherid") {
...
var nextConfigurationTests = []struct {
	...
	{Configuration{}, AddStaging, 1, "{[{Peer id1 addr1}]}"},
	{singleServer, AddStaging, 2, "{[{Peer id1 addr1x} {Peer id2 addr2}]}"},
	// AddStaging: was Peer.
	{singleServer, AddStaging, 1, "{[{Peer id1 addr1}]}"},
	// AddStaging: was Staging.
	{oneOfEach, AddStaging, 2, "{[{Peer id1 addr1x} {Peer id2 addr2} {Learner id3 addr3x}]}"},
	// AddStaging: was Learner.
	{oneOfEach, AddStaging, 3, "{[{Peer id1 addr1x} {Staging id2 addr2x} {Peer id3 addr3}]}"},

	// AddLearner: was missing.
	{singleServer, AddLearner, 2, "{[{Peer id1 addr1x} {Learner id2 addr2}]}"},
	// AddLearner: was Peer.
	{singleServer, AddLearner, 1, "{[{Peer id1 addr1}]}"},
	// AddLearner: was Staging.
	{oneOfEach, AddLearner, 2, "{[{Peer id1 addr1x} {Staging id2 addr2} {Learner id3 addr3x}]}"},
	// AddLearner: was Learner.
	{oneOfEach, AddLearner, 3, "{[{Peer id1 addr1x} {Staging id2 addr2x} {Learner id3 addr3}]}"},

	// Demote: was missing.
	{singleServer, Demote, 2, "{[{Peer id1 addr1x}]}"},
	// Demote: was Peer.
	{voterPair, Demote, 2, "{[{Peer id1 addr1x} {Learner id2 addr2x}]}"},
	// Demote: was Staging.
	{oneOfEach, Demote, 2, "{[{Peer id1 addr1x} {Learner id2 addr2x} {Learner id3 addr3x}]}"},
	// Demote: was Learner.
	{oneOfEach, Demote, 3, "{[{Peer id1 addr1x} {Staging id2 addr2x} {Learner id3 addr3x}]}"},

	// RemoveServer: was missing.
	{singleServer, RemoveServer, 2, "{[{Peer id1 addr1x}]}"},
	// RemoveServer: was Peer.
	{voterPair, RemoveServer, 2, "{[{Peer id1 addr1x}]}"},
	// RemoveServer: was Staging.
	{oneOfEach, RemoveServer, 2, "{[{Peer id1 addr1x} {Learner id3 addr3x}]}"},
	// RemoveServer: was Learner.
	{oneOfEach, RemoveServer, 3, "{[{Peer id1 addr1x} {Staging id2 addr2x}]}"},

	// Promote: was missing.
	{singleServer, Promote, 2, "{[{Peer id1 addr1x}]}"},
	// Promote: was Peer.
	{singleServer, Promote, 1, "{[{Peer id1 addr1x}]}"},
	// Promote: was Staging.
	{oneOfEach, Promote, 2, "{[{Peer id1 addr1x} {Peer id2 addr2x} {Learner id3 addr3x}]}"},
	// Promote: was Learner.
	{oneOfEach, Promote, 3, "{[{Peer id1 addr1x} {Staging id2 addr2x} {Learner id3 addr3x}]}"},
}
