...
// ServerAddressProvider provides server id to address resolution
...
// CollectLog implements the Transport interface.
func (n *NetworkTransport) CollectLog(ServerID, ServerAddress, *CollectLogRequest, *CollectLogResponse) error {
	// TODO, return
	return nil
}
