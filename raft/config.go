...
// ProtocolVersion adopted from hashicorp/raft and re-versioned from 1
type ProtocolVersion int

const (
	// ProtocolVersionMin is the lowest ProtocolVersion supported by the library (inclusive)
	ProtocolVersionMin ProtocolVersion = 1
	// ProtocolVersionMax is the highest ProtocolVersion supported by the library (inclusive)
	ProtocolVersionMax = 1
)

// SnapshotVersion adopted from hashicorp/raft and re-versioned from 1
type SnapshotVersion int

const (
	// SnapshotVersionMin is the lowest SnapshotVersion supported by the library (inclusive)
	SnapshotVersionMin SnapshotVersion = 1
	// SnapshotVersionMax is the highest SnapshotVersion supported by the library (inclusive)
