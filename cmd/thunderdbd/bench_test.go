...
func start3BPs() {
	...
	go utils.RunCommand(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/thunderdbd/leader.out"),
		},
	...
	go utils.RunCommand(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/thunderdbd/follower1.out"),
		},
	...
	go utils.RunCommand(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/thunderdbd/follower2.out"),
		},
