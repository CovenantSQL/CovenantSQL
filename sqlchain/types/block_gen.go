...
func (z *Block) Msgsize() (s int) {
	s = 1 + 13 + z.SignedHeader.Msgsize() + 8 + msgp.ArrayHeaderSize
	for za0001 := range z.Queries {
		if z.Queries[za0001] == nil {
			s += msgp.NilSize
		} else {
...
func (z *Header) Msgsize() (s int) {
	s = 1 + 8 + msgp.Int32Size + 9 + z.Producer.Msgsize() + 12 + z.GenesisHash.Msgsize() + 11 + z.ParentHash.Msgsize() + 11 + z.MerkleRoot.Msgsize() + 10 + msgp.TimeSize
	return
}
